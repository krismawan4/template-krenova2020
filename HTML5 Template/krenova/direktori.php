...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="template2/vendor/icofont/icofont.min.css" rel="stylesheet">
    <link href="template2/vendor/line-awesome/css/line-awesome.min.css" rel="stylesheet">
    <link href="template2/vendor/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="template3/fonts/icomoon/style.css">

    <link rel="stylesheet" href="template3/css/jquery-ui.css">
    <link rel="stylesheet" href="template3/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="template3/css/owl.theme.default.min.css">

    <link rel="stylesheet" href="template3/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="template3/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="template3/fonts/flaticon/font/flaticon.css">

    <link href="template3/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
    ...
    <div class="site-wrap">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-6 col-lg-2">
                        <h1 class="mb-0 site-logo"><a href="index.html" class="mb-0"><img src="template2/img/krenova01.png"></img></a></h1>
                    </div>
                        ...
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                ...
                                <li class="has-children">
                                    <a href="blog.html" class="nav-link">Informasi</a>
                                    <ul class="dropdown">
                                        <li><a href="berita.html" class="nav-link">Berita</a></li>
                                        <li><a href="panduan.html" class="nav-link">Panduan</a></li>
                                        <li><a href="daftarpemenang.html" class="nav-link">Daftar Pemenang</a></li>
                                        <li><a href="katalog.html" class="nav-link">Katalog</a></li>
                                        <li><a href="rekappendaftaran.html" class="nav-link">Rekap Pendaftaran</a></li>
                                        <li><a href="bappeda.html" class="nav-link">BAPPEDA & Litbang Kab/Kota Jawa
                                                Tengah</a></li>
                                    </ul>
                                </li>
                                <li><a href="direktori.html" class="nav-link">Direktori</a></li>
                                <li><a href="polling.html" class="nav-link">Polling</a></li>
        ...
        <main id="main">
                        ...
                        <div class="col-lg">
                            <div class=" row justify-content-center text-center mb-5">
                                <div class="col-md" data-aos="fade-up">
                                    <h2 class="section-heading">Direktori Inovasi</h2>
                                </div>
                            </div>
            </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2027713.711152872!2d109.00195553264771!3d-6.964616723839332!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e65759b9cd518dd%3A0xc377d19d8fedbc46!2sJawa%20Tengah!5e0!3m2!1sid!2sid!4v1580804382107!5m2!1sid!2sid" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen="">
                        </iframe>
                    </div>
                </div>
            </div><br><br><br>
            ...
            <footer>
                <div class="parallax100 kit-overlay1 p-t-35 p-b-15" style="background-image: url(template2/img/hero-bg.jpg);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-sm-8 col-md-5 col-lg-3 p-b-20">
                                <div class="size-h-1 flex-s-e p-b-6 m-b-18">
                                    <a href="#">
                                        <img class="max-s-full" src="template/gambar/krenova01.png" alt="IMG">
                                    </a>
                                </div>
                            ...
                            <div class="col-sm-8 col-md-5 col-lg-3 p-b-20">
                                ...
                                <ul>
                                    <li class="flex-wr-s-s t1-s-2 cl-13 p-b-9">
                                        ...
                                        <span class="size-w-4">
                                            Jl. Pemuda 127-133 Semarang 50132
                                        </span>
                                    </li>
            ...
            <script src="template2/vendor/jquery/jquery-migrate.min.js"></script>
            <script src="template2/vendor/bootstrap/js/bootstrap.min.js"></script>
            <script src="template2/vendor/easing/easing.min.js"></script>
            <script src="template2/vendor/php-email-form/validate.js"></script>
            <script src="template2/vendor/sticky/sticky.js"></script>
            <script src="template2/vendor/aos/aos.js"></script>
            <script src="template2/vendor/owlcarousel/owl.carousel.min.js"></script>
            ...
            <script src="template/vendor/revolution/js/extensions/revolution.extension.layeranimation.min.js">
            </script>
            ...
            <script src="template/js/revo-custom.js"></script>
            <!--===============================================================================================-->
            <script src="template/vendor/select2/select2.min.js"></script>
            <!--===============================================================================================-->
            <script src="template/vendor/parallax100/parallax100.js"></script>
            <!--===============================================================================================-->
            <script src="template/vendor/waypoint/jquery.waypoints.min.js"></script>
            <!--===============================================================================================-->
            <script src="template/vendor/countterup/jquery.counterup.min.js"></script>
            <!--===============================================================================================-->
            ...
            <script src="tempalte3/js/jquery-3.3.1.min.js"></script>
            <script src="tempalte3/js/jquery-migrate-3.0.1.min.js"></script>
            <script src="tempalte3/js/jquery-ui.js"></script>
            <script src="tempalte3/js/popper.min.js"></script>
            <script src="tempalte3/js/jquery.stellar.min.js"></script>
            <script src="tempalte3/js/jquery.countdown.min.js"></script>
            <script src="tempalte3/js/bootstrap-datepicker.min.js"></script>
            <script src="tempalte3/js/jquery.easing.1.3.js"></script>
            <script src="tempalte3/js/jquery.fancybox.min.js"></script>
            <script src="tempalte3/js/jquery.mb.YTPlayer.min.js"></script>
